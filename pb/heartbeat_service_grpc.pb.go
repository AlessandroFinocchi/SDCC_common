...
const (
	Heartbeat_Beat_FullMethodName = "/proto.Heartbeat/Beat"
)
...
type HeartbeatClient interface {
	...
	Beat(ctx context.Context, in *Node, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *heartbeatClient) Beat(ctx context.Context, in *Node, opts ...grpc.CallOption) (*Empty, error) {
...
type HeartbeatServer interface {
	// An host sends a heartbeat to the registry that responds with the node list of the host's cluster
	Beat(context.Context, *Node) (*Empty, error)
...
func (UnimplementedHeartbeatServer) Beat(context.Context, *Node) (*Empty, error) {
...
func _Heartbeat_Beat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartbeatServer).Beat(ctx, req.(*Node))
	}
...
var Heartbeat_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "heartbeat_service.proto",
}
